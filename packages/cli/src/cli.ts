...
const COMMAND_USAGE_LINES = [
  ...
  "run [--workflow <id>|--workflow-file <path>] --plan <id> --execute <id> [--verify <id>] --review <id> --decide <id> --task <text> [--task-file <path>] [--title <title>] [--run-id <id>] [--timeout-seconds <n>] [--user-gate] [--context-file <path> ...] [--diff-file <path>] [--verification-file <path>] [--scope <pathspec> ...] [--mcp-resource <server-id>:<resource-uri> ...] [--include-spec] [--exclude-correction <id> ...]",
  "flow run [--workflow <id>|--workflow-file <path>] --plan <id> --execute <id> [--verify <id>] --review <id> --decide <id> --task <text> [--task-file <path>] [--title <title>] [--run-id <id>] [--timeout-seconds <n>] [--user-gate] [--context-file <path> ...] [--diff-file <path>] [--verification-file <path>] [--scope <pathspec> ...] [--mcp-resource <server-id>:<resource-uri> ...] [--include-spec] [--exclude-correction <id> ...]",
