...
打开 DMG，把 `AgentMesh.app` 拖到 Applications。因为 0.1.0 的 DMG 未签名，macOS
...
- `current packet schema is active`：0.1.0 只按当前 packet schema 创建和推进 run。
