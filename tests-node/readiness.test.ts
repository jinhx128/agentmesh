...
test("skill output declares AgentMesh protocol version metadata", () => {
  ...
  assert.match(showResult.stdout, /AgentMesh CLI version: 0\.3\.2/);
  ...
  assert.match(exportResult.stdout, /AgentMesh CLI version: 0\.3\.2/);
  ...
  assert.match(installedSkill, /AgentMesh CLI version: 0\.3\.2/);
