...
- [ ] **Step 1: 写 RED 主题与 token contract**
...
进度记录：状态 `pending`；证据待执行；下一步 `P1.1 Step 1`。
...
进度记录：状态 `pending`；证据待执行；下一步由 `P1.2` 收尾更新为 `P1.3 Step 1`。
...
- 当前下一步：`P1.1 Step 1`，写主题与 token RED contract。
